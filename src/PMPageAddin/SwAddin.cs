...
#region SolidWorks dll引用,在SolidWorks安装目录可以找到
...
{
    /// <summary>
    /// Summary description for PMPageAddin.(插件描述信息)
    /// </summary>
    [Guid("0bd9ae5e-4c19-44af-a585-28631886305a"), ComVisible(true)]
    [SwAddin(
        Description = "PMPageAddin description(在这里填写你的插件描述)",
        Title = "PMPageAddin",
        //设置是否在SolidWorks打开时加载此插件
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        #region Local Variables(本地变量)
        ...
        #region SolidWorks Registration(插件注册)
        ...
        #region ISwAddin Implementation(连接SolidWorks)
        public SwAddin()
        {
        }
        ...
        #region UI Methods(设置SolidWorks按钮和UI)
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("PMPageAddin.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("PMPageAddin.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("PMPageAddin.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("PMPageAddin.MainIconSmall.bmp", thisAssembly);
        ...
        #region Event Methods(监听SolidWorks事件)
